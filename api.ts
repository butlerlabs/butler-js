...
export const QueuesApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        extractFile: async (queueId: string, file?: any, options: any = {}): Promise<RequestArgs> => {
            // verify required parameter 'queueId' is not null or undefined
            assertParamExists('extractFile', 'queueId', queueId)
...
export const QueuesApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async extractFile(queueId: string, file?: any, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<ExtractionResultsDto>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.extractFile(queueId, file, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
        /**
         *
...
export const QueuesApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        extractFile(queueId: string, file?: any, options?: any): AxiosPromise<ExtractionResultsDto> {
            return localVarFp.extractFile(queueId, file, options).then((request) => request(axios, basePath));
        },
        /**
         *
         * @summary Get paginated list of extraction results for documents matching the query params
...
export class QueuesApi extends BaseAPI {
     ...
     * @memberof QueuesApi
     */
    public extractFile(queueId: string, file?: any, options?: any) {
        return QueuesApiFp(this.configuration).extractFile(queueId, file, options).then((request) => request(this.axios, this.basePath));
    }
